...
def test_cov_se(benchmark):
    cov_ = benchmark.pedantic(_cov_main_vector, args=('se', 3, 1000, 2000), rounds=100, iterations=1)
    print(cov_)

@pytest.mark.timeout(200)
def test_cov_set_se(benchmark):
    cov_ = benchmark.pedantic(_cov_main_set, args=('set_se', 3, 100, 200, 10, 40), rounds=100, iterations=1)
    print(cov_)

@pytest.mark.timeout(50)
def test_cov_matern32(benchmark):
    cov_ = benchmark.pedantic(_cov_main_vector, args=('matern32', 3, 1000, 2000), rounds=100, iterations=1)
    print(cov_)

@pytest.mark.timeout(200)
def test_cov_set_matern32(benchmark):
    cov_ = benchmark.pedantic(_cov_main_set, args=('set_matern32', 3, 100, 200, 10, 40), rounds=100, iterations=1)
    print(cov_)

@pytest.mark.timeout(50)
def test_cov_matern52(benchmark):
    cov_ = benchmark.pedantic(_cov_main_vector, args=('matern52', 3, 1000, 2000), rounds=100, iterations=1)
    print(cov_)

@pytest.mark.timeout(200)
def test_cov_set_matern52(benchmark):
    cov_ = benchmark.pedantic(_cov_main_set, args=('set_matern52', 3, 100, 200, 10, 40), rounds=100, iterations=1)
    print(cov_)
