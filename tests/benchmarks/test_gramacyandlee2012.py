...
TEST_EPSILON = 1e-5
FUN_TARGET = benchmarks.gramacyandlee2012
INFO_FUN = benchmarks.INFO_GRAMACYANDLEE2012
INT_DIM = 1
...
def test_function():
    ...
    assert (np.abs(FUN_TARGET(np.ones(1)) - (-6.123234e-16)) < TEST_EPSILON).all()
