# example_benchmarks_eggholder_bo_ei
...
def main():
    ...
    for ind_bo in range(0, num_bo):
        ...
        X_final, Y_final, time_final, _, _ = wrappers_bo_function.run_single_round(model_bo, fun_target, num_init, num_iter, str_initial_method_bo='halton', str_sampling_method_ao='halton', num_samples_ao=100, seed=42 * (ind_bo + 1))
        print(X_final)
        print(Y_final)
        print(time_final)
