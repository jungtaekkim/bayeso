...
def main():
    ...
    model_bo = bo_w_tp.BOwTP(np.array([[-6., 6.]]), str_acq=str_acq, debug=debug)
    ...
    for ind_ in range(1, num_iter + 1):
        ...
        nu_test, mu_test, sigma_test, Sigma_test = tp.predict_with_cov(X_train, Y_train, X_test, cov_X_X, inv_cov_X_X, hyps)
